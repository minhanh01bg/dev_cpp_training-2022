...
//	}
	...
	if (A.first == B.first)
	{
		if (A.first == C.first && A.first == A.second + B.second + C.second)
		{
			cout<<"YES";
			return 0;
		}
	...
	if (B.first == C.first && B.second + C.second == A.first && B.first == A.first - A.second) 
	{
		cout<<"YES";
		return 0;
	}
	if (B.first == C.second && B.second + C.first == A.first && B.first == A.first - A.second) 
	{
		cout<<"YES";
		return 0;
	}
	if (B.second == C.first && B.first + C.second == A.first && B.second == A.first - A.second) 
	{
		cout<<"YES";
		return 0;
	}
	if (B.second == C.second && B.first + C.first == A.first && B.second == A.first - A.second) 
	{
		cout<<"YES";
		return 0;
	}
